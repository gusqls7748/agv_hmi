...
ApplicationWindow {
    ...
    Connections {
        ...
        function onManualModeChanged(enabled) {
    ...
    ColumnLayout {
        ...
        Rectangle {
            ...
            Text {
                anchors.centerIn: parent
                text: hmiController.isManualMode
                      ? "수동 제어 모드 (MANUAL)"
                      : "자동 주행 모드 (AUTO)"
                color: "white"
                font.pixelSize: 22
        ...
        RowLayout {
            ...
            Switch {
                checked: hmiController.isManualMode
                onToggled: hmiController.setManualMode(checked)
            }
        ...
        GridLayout {
            ...
            Button {
                ...
                Layout.preferredHeight: 80
                enabled: hmiController.isManualMode
                onPressed: hmiController.sendCommand("left")
                onReleased: hmiController.sendCommand("stop")
            }
            ...
            Button {
                ...
                Layout.preferredHeight: 80
                enabled: hmiController.isManualMode
                onClicked: hmiController.sendCommand("stop")
            }
            ...
            Button {
                ...
                Layout.preferredHeight: 80
                enabled: hmiController.isManualMode
                onPressed: hmiController.sendCommand("right")
                onReleased: hmiController.sendCommand("stop")
            }
            ...
            Button {
                ...
                Layout.preferredHeight: 80
                enabled: hmiController.isManualMode
                onPressed: hmiController.sendCommand("backward")
                onReleased: hmiController.sendCommand("stop")
            }
